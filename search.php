			...
			<section class="search-page section-py">
				<div class="container">
					<div class="search-header text-center mb-base">
						...
						<div class="search-total mt-2 text-utility-700">Tìm thấy
							<?php echo esc_html($total_posts_found); ?>
							kết quả</div>
					</div>
					...
					<!-- <div class="search-tabs mb-base">
						<ul class="search-tab-nav flex flex-wrap justify-center gap-3">
							...
							<li>
								<button class="search-tab-btn btn btn-outline"
									data-tab="<?php echo esc_attr($slug); ?>"><i
