	...
	<section class="section-services-detail-3 section-py">
		<div class="swiper-services-detail">
			...
			<div class="swiper-navigation">
				<div class="swiper-button-deGallery-prev swiper-button-vuong"><i class="fa-solid fa-chevron-left"></i>
				</div>
				<div class="swiper-button-deGallery-next"><i class="fa-solid fa-chevron-right swiper-button-vuong"></i>
				</div>
			</div>
		</div>
	</section>
		...
		<div class="container">
			...
			<div class="swiper-services-other">
				...
				<div class="swiper-navigation-center-y">
					<div class="swiper-button-other-prev swiper-button-vuong"><i class="fa-solid fa-chevron-left"></i>
					</div>
					<div class="swiper-button-other-next swiper-button-vuong"><i class="fa-solid fa-chevron-right"></i>
					</div>
				</div>
			</div>
		</div>
