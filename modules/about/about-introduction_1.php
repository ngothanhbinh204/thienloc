	...
	<div class="container">
		<div class="intro-grid">
			<div class="col-content">
				...
				<?php if ($description) : ?>
				<div class="content-html text-justify mb-8" data-aos="fade-right" data-aos-delay="200">
					<?= $description; ?>
				</div>
				<?php endif; ?>
		...
		<div class="list-stats">
			...
			<div class="stat-item" data-aos="fade-up" data-aos-delay="<?= $delay; ?>">
				...
				<div class="stat-info">
					<div class="stat-number"><span class="counter"><?= esc_html($number); ?></span><span>+</span></div>
